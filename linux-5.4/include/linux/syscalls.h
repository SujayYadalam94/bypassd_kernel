...
asmlinkage long sys_openat(int dfd, const char __user *filename, int flags,
			   umode_t mode);
asmlinkage unsigned long sys_openat_swiftcore(int dfd, const char __user *filename, int flags,
			   umode_t mode);
asmlinkage unsigned long sys_drop_pt_swiftcore(int dfd);
asmlinkage unsigned long sys_swiftcore_expose_tables(unsigned long fd);
